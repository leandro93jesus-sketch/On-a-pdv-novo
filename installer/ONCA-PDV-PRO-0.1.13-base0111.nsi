Unicode true
Name "ONCA PDV PRO"
OutFile "ONCA-PDV-PRO-Setup-0.1.13-BASE-0111.exe"
InstallDir "$LOCALAPPDATA\Programs\ONCA-PDV-PRO"
RequestExecutionLevel user
SetCompressor /SOLID lzma

VIProductVersion "0.1.13.0"
VIAddVersionKey /LANG=1046 "ProductName" "ONCA PDV PRO"
VIAddVersionKey /LANG=1046 "CompanyName" "ONCA Produtos de Limpeza"
VIAddVersionKey /LANG=1046 "FileDescription" "ONCA PDV PRO 0.1.13 - visual 0.1.11 com melhorias"
VIAddVersionKey /LANG=1046 "FileVersion" "0.1.13"
...
Section "ONCA PDV PRO" SEC01
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\ONCA-PDV-PRO" "DisplayVersion" "0.1.13"
...
Section "Uninstall"
  ...
  ; Dados ficam preservados em %LOCALAPPDATA%\Onca PDV Pro\data
SectionEnd
