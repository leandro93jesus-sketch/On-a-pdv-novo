...
try {
 ...
 $setup=Wait-Window $p "Redefinição única do PIN"
 ...
 Click $setupRoot "SALVAR NOVO PIN"
 Click-Dialog $p "ONÇA PDV" @("OK")
 Write-Host "FIRST_UPGRADE_PIN_SETUP_UI_OK"
 ...
 Write-Host "UI_CANCEL_042_FULL_FLOW_PASS=YES"
